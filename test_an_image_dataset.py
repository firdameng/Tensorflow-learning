...
DATASET_PATH = './data/Test/'  # the dataset file or root folder path.

# Image Parameters
N_CLASSES = 95  # CHANGE HERE, total number of classes
IMG_HEIGHT = 100  # CHANGE HERE, the image height to be resized to
IMG_WIDTH = 100  # CHANGE HERE, the image width to be resized to
...
with tf.Session() as sess:
    saver.restore(sess, "./model/fruits.tfmodel")
    # # Run the initializer
    # sess.run(init)
    ...
    #
    # # Save your model
    # saver.save(sess, './model/fruits.tfmodel')
